...
namespace Presentation.Seccion_de_Administrador
{
    partial class FrmReporteMaestros
    {
        ...
        private void InitializeComponent()
        {
            ...
            colGrupos = new DataGridViewTextBoxColumn();
            colEstudiantes = new DataGridViewTextBoxColumn();
            ...
            dgvMaestros.Columns.AddRange(new DataGridViewColumn[] { colUsuario, colEmail, colTelefono, colNivel, colFechaIngreso, colGrupos, colEstudiantes, colEstado });
            ...
            dgvMaestros.Location = new Point(12, 225);
            dgvMaestros.Name = "dgvMaestros";
            dgvMaestros.ReadOnly = true;
            dgvMaestros.RowHeadersVisible = false;
            dgvMaestros.Size = new Size(565, 191);
            dgvMaestros.TabIndex = 1;
            ...
            dgvMaestros.ThemeStyle.HeaderStyle.Font = new Font("Segoe UI", 8F, FontStyle.Bold);
            ...
            // colGrupos
            // 
            colGrupos.HeaderText = "Grp";
            colGrupos.Name = "colGrupos";
            colGrupos.ReadOnly = true;
            // 
            // colEstudiantes
            // 
            colEstudiantes.HeaderText = "Est";
            colEstudiantes.Name = "colEstudiantes";
            colEstudiantes.ReadOnly = true;
            // 
            // colEstado
            // 
            ...
            panelDescripcion.Location = new Point(12, 419);
            ...
            lblDescripcion.Text = "Listado completo de maestros: información de contacto, nivel, grupos, estudiantes y estado.";
            // 
            // panelFirma
            // 
            ...
            panelFirma.Location = new Point(12, 472);
            ...
            btnImprimir.Location = new Point(12, 123);
            ...
            lblNombreReporte.Location = new Point(182, 105);
            lblNombreReporte.Name = "lblNombreReporte";
            lblNombreReporte.Size = new Size(191, 30);
            lblNombreReporte.TabIndex = 0;
            lblNombreReporte.Text = "Reporte de Maestros";
            // 
            // panelFiltro
            // 
            ...
            panelFiltro.Location = new Point(12, 164);
            ...
            Name = "FrmReporteMaestros";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Reporte: Maestros";
            Load += FrmReporteMaestros_Load;
