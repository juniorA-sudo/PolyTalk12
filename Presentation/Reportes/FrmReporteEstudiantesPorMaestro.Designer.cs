...
namespace Presentation.Seccion_de_Administrador
{
    partial class FrmReporteEstudiantesPorMaestro
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmReporteEstudiantesPorMaestro));
            ...
            lblSeleccionarMaestro = new Guna2HtmlLabel();
            cmbMaestro = new Guna2ComboBox();
            ...
            lblDirigido.Text = "Supervisión académica para evaluar preferencias y progreso en vocabulario";
            // 
            // panelSelector
            // 
            panelSelector.BackColor = Color.Transparent;
            panelSelector.BorderRadius = 8;
            panelSelector.Controls.Add(lblSeleccionarMaestro);
            panelSelector.Controls.Add(lblNombreReporte);
            panelSelector.Controls.Add(cmbMaestro);
            panelSelector.CustomizableEdges = customizableEdges5;
            panelSelector.FillColor = Color.White;
            panelSelector.Location = new Point(12, 120);
            ...
            // 
            // lblSeleccionarMaestro
            // 
            lblSeleccionarMaestro.AutoSize = false;
            lblSeleccionarMaestro.BackColor = Color.Transparent;
            lblSeleccionarMaestro.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblSeleccionarMaestro.ForeColor = Color.FromArgb(64, 64, 64);
            lblSeleccionarMaestro.Location = new Point(328, 13);
            lblSeleccionarMaestro.Name = "lblSeleccionarMaestro";
            lblSeleccionarMaestro.Size = new Size(130, 20);
            lblSeleccionarMaestro.TabIndex = 0;
            lblSeleccionarMaestro.Text = "Seleccionar Maestro:";
            // 
            // cmbMaestro
            // 
            cmbMaestro.BackColor = Color.Transparent;
            cmbMaestro.BorderRadius = 5;
            cmbMaestro.CustomizableEdges = customizableEdges3;
            cmbMaestro.DrawMode = DrawMode.OwnerDrawFixed;
            cmbMaestro.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbMaestro.FocusedColor = Color.FromArgb(0, 82, 180);
            cmbMaestro.FocusedState.BorderColor = Color.FromArgb(0, 82, 180);
            cmbMaestro.Font = new Font("Segoe UI", 9F);
            cmbMaestro.ForeColor = Color.FromArgb(68, 88, 112);
            cmbMaestro.ItemHeight = 30;
            cmbMaestro.Items.AddRange(new object[] { "Laura Gómez", "Roberto Díaz", "Carolina Silva", "Pedro Méndez" });
            cmbMaestro.Location = new Point(464, 5);
            cmbMaestro.Name = "cmbMaestro";
            cmbMaestro.ShadowDecoration.CustomizableEdges = customizableEdges4;
            cmbMaestro.Size = new Size(86, 36);
            cmbMaestro.TabIndex = 0;
            // 
            // dgvEstudiantes
            // 
            ...
            dgvEstudiantes.Columns.AddRange(new DataGridViewColumn[] { colNombre, colNivel, colProgreso, colAsistencia, colCalificacion, colFechaIngreso, colGrupo });
            ...
            dgvEstudiantes.Location = new Point(12, 178);
            dgvEstudiantes.Name = "dgvEstudiantes";
            dgvEstudiantes.ReadOnly = true;
            dgvEstudiantes.RowHeadersVisible = false;
            dgvEstudiantes.Size = new Size(565, 140);
            ...
            panelDescripcion.Location = new Point(12, 326);
            ...
            panelFirma.Location = new Point(12, 384);
            ...
            btnImprimir.Location = new Point(12, 125);
            ...
            lblNombreReporte.Location = new Point(106, 13);
            lblNombreReporte.Name = "lblNombreReporte";
            lblNombreReporte.Size = new Size(300, 25);
            lblNombreReporte.TabIndex = 11;
            lblNombreReporte.Text = "Estudiantes por maestro";
            // 
            // FrmReporteEstudiantesPorMaestro
            // 
            ...
            Name = "FrmReporteEstudiantesPorMaestro";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Reporte: Estudiantes por Maestro";
